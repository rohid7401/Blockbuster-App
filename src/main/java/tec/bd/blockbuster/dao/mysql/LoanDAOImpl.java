...
public abstract class LoanDAOImpl extends GenericMySqlDAOImpl<Loan, Long> implements LoanDAO {
    ...
    public List<Loan> findAllLoan() {
        ...
        try {
            ...
            var stmt = dbConnection.prepareStatement(SQL_FIND_ALL_LOANS);
    ...
    public Optional<Loan> findByCedLoan(Long cedula) {
        ...
        try {
            dbConnection = this.dataSource.getConnection();
            var stmt = dbConnection.prepareStatement(SQL_FIND_BY_CED_LOAN);
    ...
    public Optional<Loan> findByCodLoan(Long codigo) {
        ...
        try {
            dbConnection = this.dataSource.getConnection();
            var stmt = dbConnection.prepareStatement(SQL_FIND_BY_COD);
    ...
    public void saveLoan(Loan loan) {
        ...
        try {
            dbConnection = this.dataSource.getConnection();
            PreparedStatement insertCategory = dbConnection.prepareStatement(PROC_CREATE_LOAN);
    ...
    public void updateLoan(long cedula, long codigo, String estado, Date fecha_devolucion) {
        ...
        try {
            dbConnection = this.dataSource.getConnection();
            CallableStatement stmt = dbConnection.prepareCall(PROC_UPDATE_LOAN);
            stmt.setLong(1, cedula);
            stmt.setLong(2, codigo);
