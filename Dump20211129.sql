...
--
-- Current Database `blockbuster`
--
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `blockbuster` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
INSERT INTO `pelicula` VALUES(1, 'Godzilla vs. Kong', 20210331, 2),(2, 'Venom', 20181005, 1),(3, 'Soul ', 20201011, 4),(4, 'Spider-Man: Far from Home', 20190502, 1),(5, 'Joker', 20191004, 3),(6, 'Avengers: Endgame', 20190426, 1),(7, 'The Chronicles of Narnia', 20101210, 4),(8, 'Nanny McPhee Returns', 20100402, 5),(9, 'How to Train Your Dragon', 20100321, 6),(10, 'Toy Story 3', 20100518, 5);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `createCategory`(in id int,in nombre VARCHAR(30))
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `createLoan`(in ced int,in cod int,in est VARCHAR(20),in fp date,in fd date)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteLoan`(in ced int,in cod int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `readCategory`(in id int)
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `readLoan` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `readLoan`(in ced int,in cod int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateCategory`(in id int,in nombre varchar(30))
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateLoan`(in ced int,in cod int,in est VARCHAR(20),in fd date)
begin
...
-- Dump completed on 2021-11-29 10:32:18

drop user 'blockbuster_user@localhost';
create user 'blockbuster_user@localhost' identified by 'blockbuster_pass';
grant select, insert, delete, update, execute on blockbuster.* to 'blockbuster_user@localhost';
